// Generated from C:/Users/mazen/Desktop/compiler1/src/html/grammars/HtmlLexer.g4 by ANTLR 4.13.2
...
public class HtmlLexer extends Lexer {
	...
	public static final int
		HTML=1, JINJA_VAR=2, JINJA_BLOCK=3, CSS=4;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "HTML", "JINJA_VAR", "JINJA_BLOCK", "CSS"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"ID_START", "ID_PART", "IDENTIFIER", "DOT", "WS", "STYLE_OPEN", "HTML_OPEN_TAG", 
			"JINJA_VAR_OPEN", "JINJA_BLOCK_OPEN", "HTML_TEXT", "HTML_WS", "STYLE_OPEN_IN_HTML", 
			"HTML_CLOSE_TAG", "HTML_TEXT_INNER", "HTML_JINJA_VAR_OPEN", "HTML_JINJA_BLOCK_OPEN", 
			"JINJA_VAR_CLOSE", "JINJA_VAR_WS", "JINJA_VAR_NAME", "JINJA_VAR_DOT", 
			"JINJA_BLOCK_CLOSE", "FOR", "IN", "IF", "ENDIF", "ENDFOR", "JINJA_BLOCK_NAME", 
			"JINJA_BLOCK_DOT", "JINJA_BLOCK_WS", "STYLE_CLOSE", "CSS_DOT", "CSS_HASH", 
			"CSS_IDENT", "CSS_NUMBER", "CSS_UNIT", "CSS_STRING", "CSS_COLON", "CSS_SEMI", 
			"CSS_LBRACE", "CSS_RBRACE", "CSS_WS"
		};
	}
